...
Public LongBench slice (60 @4k truncate) & full F1 \textbf{0.28}/hit 23--25\%; novelty \textbf{0.18--0.19}/10\%; valley \textbf{0.18}/8\% \\
Posthoc query-aware UB (same 60) & posthoc@512 \textbf{0.95$\times$} full F1; @1024/2048 $\sim$\textbf{1.0$\times$} (peak=$L$) \\
query\_hold Pareto (hold$\times$final) & best h2048$\to$f1024 $\approx$\textbf{0.92$\times$} full @ peak $\sim$2.5k; novelty@512 \textbf{0.64$\times$} @1k \\
